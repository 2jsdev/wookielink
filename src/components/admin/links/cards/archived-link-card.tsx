...
import PermanentElimination from '@/components/admin/links/cards/sections/permanent-elimination';
import RestoreLink from '@/components/admin/links/cards/sections/restore-link';
